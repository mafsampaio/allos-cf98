...
Documentation=https://github.com/giovani-junior-dev/Allos
...
# --- config ---
REPO_URL="${REPO_URL:-https://github.com/giovani-junior-dev/Allos.git}"
...
curl -fsSL https://raw.githubusercontent.com/giovani-junior-dev/Allos/main/install/deploy_vps.sh | sudo bash
