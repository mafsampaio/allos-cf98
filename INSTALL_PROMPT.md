...
Prompt único para instalar o Allos do zero numa máquina nova usando Claude Code.
...
```
Voce e um instalador automatizado do projeto Allos (WhatsApp + Claude Code agent).
Repositorio: https://github.com/giovani-junior-dev/Allos
...
- Pergunte ao usuario onde quer clonar (default: cwd atual, pasta `Allos`).
- Rode: git clone https://github.com/giovani-junior-dev/Allos.git Allos
- cd Allos
- A partir daqui, todos comandos rodam dentro da pasta Allos.
...
- Diga ao usuario para abrir OUTRO terminal, fazer `cd Allos`, rodar `claude`,
  e colar:
